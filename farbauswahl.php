...
$regalfach_pro_regal = array(12, 16 , 14, 12, 12);               //todo modularer machen also function schreiben
    ...
    if (isset($_POST['alleregale'])) {
        ...
        $befehlsstring = generatebefehlsstring($ledarray);
...
<head>
    ...
    function ajax_post(){
        ...
        var befehlsstring = document.getElementById("versteckterbutton").value;
        var vars = "red="+red+"&green="+green+"&blue="+blue+"&befehlsstring="+befehlsstring+"&hexfarbe="+hexfarbe+"&farbe="+farbe;
...
<div id="farbauswahlbackground" class="background">
    ...
    <div id="farbauswahl">
        ...
        <div id="links">
            <table id="farbtabellenid">
                <tr>
                    <td class="farbtabelle"><button id="rot" class="farbe" value="ff0000"></button></td>
                    <td class="farbtabelle"><button id="gruen" class="farbe" value="00ff00"></button></td>
                    <td class="farbtabelle"><button id="blau" class="farbe" value="0000ff"></button></td>
                    <td class="farbtabelle"><button id="gelb" class="farbe" value="ffff00"></button></td>
                </tr>
                <tr>
                    <td class="farbtabelle"><button id="weiss" class="farbe"></button></td>
                    <td class="farbtabelle"><button id="schwarz" class="farbe"></button></td>
                    <td class="farbtabelle"><button id="orange" class="farbe"></button></td>
                    <td class="farbtabelle"><button id="pink" class="farbe"></button></td>
                </tr>
                <tr>
                    <td class="farbtabelle"><button id="" class="farbe"></button></td>
                    <td class="farbtabelle"><button id="" class="farbe"></button></td>
                    <td class="farbtabelle"><button id="" class="farbe"></button></td>
                    <td class="farbtabelle"><button id="lila" class="farbe"></button></td>
                </tr>
                <tr>
                    <td class="farbtabelle"><button id="" class="farbe" value="ff0000"></button></td>
                    <td class="farbtabelle"><button id="" class="farbe" value="00ff00"></button></td>
                    <td class="farbtabelle"><button id="" class="farbe" value="0000ff"></button></td>
                    <td class="farbtabelle"><button id="" class="farbe" value="ffff00"></button></td>
                </tr>
                <tr>
                    <td class="farbtabelle"><button id="" class="farbe"></button></td>
                    <td class="farbtabelle"><button id="" class="farbe"></button></td>
        ...
        <div id="rechts">
                ...
                <input id="versteckterbutton" name="versteckterbutton" type="hidden" value="<?php echo $befehlsstring; ?>">
