!function () {
    ...
    var t = function () {
        function t(t) {
            var e = t.r, i = t.g, r = t.b, a = Math.max(e, i, r), s = Math.min(e, i, r), h = a - s, o,
                n = 0 === a ? 0 : h / a, l = a / 255;
            switch (a) {
                case s:
                    o = 0;
        ...
        return document.body.addEventListener("touchmove", t, !1), document.body.addEventListener("touchend", r, !1), document.body.addEventListener("mousemove", t, !1), document.body.addEventListener("mouseup", r, !1), s.prototype._solveLayout = function (t) {
            var e = t.padding + 2 || 6, i = t.sliderMargin || 24, r = t.markerRadius || 8,
                a = t.sliderHeight || 2 * r + 2 * e, s = Math.min(this.height - a - i, this.width),
                h = (this.width - s) / 2;
            return {
                Mr: r,
                Rd: s,
            ...
            if ("slider" == this._target) t = Math.max(Math.min(t, i.Sre), i.Srs) - i.Srs, this.color.set({v: ~~(100 / i.Srw * t)}); else if ("ring" == this._target) {
                var r = Math.atan2(t - i.Rcx, e - i.Rcy), a = 360 - ~~((r * (180 / Math.PI) + 270) % 360),
                    s = Math.min(Math.sqrt((i.Rcx - t) * (i.Rcx - t) + (i.Rcy - e) * (i.Rcy - e)), i.Re);
